          ...
          <PagerView style={styles.viewPager} scrollEnabled={false} initialPage={0} ref={viewPagerRef}>
              <View style={styles.page} key="1">
                <View style={styles.pageContainer}>
                    ...
                    <TextInput
                      style={styles.inputBox} value={firstName}
                      onChangeText={onChangeFirstName} placeholder={"First Name"}
                    />
                </View>
                ...
                <Pressable style={[styles.btn, validateName(firstName) ? styles.btnDisabled : "" ]} onPress={() => viewPagerRef.current.setPage(1)} disabled={validateName(firstName)}>
            ...
            <View style={styles.page} key="2">
                ...
                <View style={styles.buttons}>
                  ...
                  <Pressable style={[styles.halfBtn, validateName(lastName) ? styles.btnDisabled : ""]} onPress={() => viewPagerRef.current.setPage(2)} disabled={validateName(lastName)}>
                    <Text style={styles.btntext}>Next</Text>
                  </Pressable>
                </View>
            </View>
            ...
            <View style={styles.page} key="3">
                ...
                <View style={styles.buttons}>
                    ...
                    <Pressable
                      ...
                      onPress={() => onboard({ firstName, lastName, email })} disabled={!isEmailValid}
                    >
